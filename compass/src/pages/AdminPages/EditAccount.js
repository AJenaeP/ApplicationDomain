...
const EditAccount = ({ account }) => {
  ...
  function handleAccountDescChange(e) {
    updatedAccount.accountDescription = e.target.value;
  }
  function handleAccountCatChange(e) {
    setUpdatedCategory(e.target.value);
    updatedAccount.accountCategory = e.target.value;
  }
  function handleAccountSubCatChange(e) {
    setUpdatedSubcategory(e.target.value);
    updatedAccount.accountSubcategory = e.target.value;
  }
  function handleAccountInitialChange(e) {
    updatedAccount.initialBalance = Number(e.target.value);
  }
  ...
  function handleAccountStatusChange(e) {
    ...
    updatedAccount.accountStatus = e.target.value;
  }
