...
const EditJournal = ({ journal }) => {
  ...
  function handleJournalDateChange(e) {
    updatedJournal.date = e.target.value;
  }
  function handleJournalAccountNameChange(e) {
    updatedJournal.journalName = e.target.value;
  }
  function handleJournalRefChange(e) {
    updatedJournal.ref = e.target.value;
  }
  function handleJournalDebitChange(e) {
    updatedJournal.debit = Number(e.target.value);
  }
  function handleJournalCreditChange(e) {
    updatedJournal.credit = Number(e.target.value);
  }
  function handleJournalStatusChange(e) {
    updatedJournal.journalStatus = e.target.value;
  }
  function handleJournalCommentChange(e) {
