...
const AdjustJournal = ({ journal }) => {
  ...
  function handleJournalAccountNameChange(e) {
    adjustJournal.account_name = e.target.value;
  }
  function handleJournalRefAdjust(e) {
    adjustJournal.ref = e.target.value;
  }
  function handleJournalDebitAdjust(e) {
    adjustJournal.debit = Number(e.target.value);
  }
  function handleJournalCreditAdjust(e) {
    adjustJournal.credit = Number(e.target.value);
  }
  function handleJournalExplanationAdjust(e) {
    adjustJournal.explanation = e.target.value;
  }
  function handleAdjustStatusChange(e) {
    adjustJournal.journal_status = e.target.value;
  }
  function handleAdjustCommentChange(e) {
    adjustJournal.journal_comment = e.target.value;
  }
    ...
    return (
      <>
        ...
        >
          ...
          <MenuItem value="InaccurateAdjustment">
