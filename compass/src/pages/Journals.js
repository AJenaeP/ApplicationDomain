                ...
                return (
                  <>
                    ...
                    >
                      ...
                      <TableCell key={i + "debit"}>
                        {numberFormat(journal.debit)}
                      </TableCell>
                      <TableCell
                        key={i + "adjusted_debit"}
                        className={"adjusted_debit"}
                      >
                        {numberFormat(journal.adjusted_debit)}
                      </TableCell>
                      <TableCell key={i + "credit"}>
                        {numberFormat(journal.credit)}
                      </TableCell>
                      <TableCell
                        key={i + "adjusted_credit"}
                        className={"adjusted_credit"}
                      >
                        {numberFormat(journal.adjusted_credit)}
                      </TableCell>
                      <TableCell
                        key={i + "explanation"}
                      ...
                      <TableCell
                        key={i + "status"}
                        className={
                          (journal.journal_status === "Approved"
                            ? "approved"
                            : "") ||
                          (journal.journal_status === "Pending"
                            ? "pending"
                            : "") ||
                          (journal.journal_status === "Rejected"
                            ? "rejected"
                            : "")
                        }
                      >
